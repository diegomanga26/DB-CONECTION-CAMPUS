<?php
    ...
    $router->put("/caps", function(){
        ...
        $res-> bindValue("ID_THEMATIC_UNITS", $_DATA['id_thematic_units']); //para editar se debe escribir la sentencia dentro del $_DATA["nom"] es decir { nom: Wilfer, id: 1}
    ...
    $router->post("/caps", function(){
        ...
        $res-> bindValue("END_DATE", $_DATA['end_date']);
        $res-> bindValue("DESCRIPTION", $_DATA['description']);
        $res-> bindValue("DURATION_DAYS", $_DATA['duration_days']); //para editar se debe escribir la sentencia dentro del $_DATA["nom"] es decir { nom: Wilfer, id: 1}
        $res -> execute();
        $res = $res->rowCount();
        echo json_encode($res);
    });
    ...
    $router->put("/city", function(){
        ...
        $res-> bindValue("NAME_CITY", $_DATA['name_city']); //para editar se debe escribir la sentencia dentro del $_DATA["nom"] es decir { nom: Wilfer, id: 1}
    ...
    $router->put("/ref", function(){
        ...
        $res-> bindValue("FULL_NAME", $_DATA['full_name']); //para editar se debe escribir la sentencia dentro del $_DATA["nom"] es decir { nom: Wilfer, id: 1}
    ...
    $router->put("/lev", function(){
        ...
        $res-> bindValue("NAME_LEVEL", $_DATA['name_level']); //para editar se debe escribir la sentencia dentro del $_DATA["nom"] es decir { nom: Wilfer, id: 1}
    ...
    $router->put("/reg", function(){
        ...
        $res-> bindValue("NAME_REGION", $_DATA['name_region']); //para editar se debe escribir la sentencia dentro del $_DATA["nom"] es decir { nom: Wilfer, id: 1}
